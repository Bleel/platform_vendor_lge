...
include $(CLEAR_VARS)
LOCAL_MODULE := boot-QPerformance
LOCAL_MODULE_OWNER := lge
LOCAL_SRC_FILES := proprietary/framework/boot-QPerformance.vdex
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
...
include $(CLEAR_VARS)
LOCAL_MODULE := boot-UxPerformance
LOCAL_MODULE_OWNER := lge
LOCAL_SRC_FILES := proprietary/framework/boot-UxPerformance.vdex
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .vdex
